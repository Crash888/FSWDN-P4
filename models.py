...
add session, speaker and wishlist forms by David D 2016 Jan 26 
...
class WishlistForm(messages.Message):
    ...
    websafeSessionKey   = messages.StringField(5)
    

class WishlistForms(messages.Message):
    """WishlistForms -- multiple  outbound form message"""
...
class SpeakerForm(messages.Message):
    ...
    sessionKeysToSpeak = messages.StringField(4, repeated=True)

class SpeakerForms(messages.Message):
    """SpeakerForms -- multiple  outbound form message"""
